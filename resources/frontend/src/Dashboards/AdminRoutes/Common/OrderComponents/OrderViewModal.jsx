                                ...
                                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div>
                                                <p className="text-red-700 font-medium">Cancelled At</p>
                                                <p className="text-red-900">
                                                    {order.cancelled_at ? dayjs(order.cancelled_at).format("MMM D, YYYY h:mm A") : 'N/A'}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    {order.cancelled_at && order.created_at && (
                                        <div className="mt-3 pt-3 border-t border-red-200">
                                            <p className="text-red-700 text-sm">
                                                Order was active for {dayjs(order.cancelled_at).diff(dayjs(order.created_at), 'minute')} minutes before cancellation
                                            </p>
                                        </div>
                                    )}
                                </div>
