...
const ValidationResults = ({ validationResult }) => {
    if (!validationResult || (validationResult.status && validationResult.status !== 'failed')) {
        return null;
    }
    ...
    const hasDetailsErrors = validationResult.details_errors &&
    ...
    const hasPricingErrors = validationResult.pricing_errors &&
    ...
    if (!hasDetailsErrors && !hasPricingErrors) {
        return (
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                ...
                <p className="text-red-600 text-sm">An unknown error occurred during validation.</p>
            </div>
        );
    }
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
            ...
            {hasDetailsErrors && (
                <div className="mb-3">
                    ...
                    <ul className="text-red-600 text-sm list-disc list-inside">
                        {getErrors(validationResult.details_errors).map((error, index) => (
            ...
            {hasPricingErrors && (
                <div>
                    ...
                    <ul className="text-red-600 text-sm list-disc list-inside">
                        {getErrors(validationResult.pricing_errors).map((error, index) => (
