...
const FileUpload = ({ files, onFileSelect, onRemoveFile, onDownloadTemplate }) => {
    return (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="bg-white rounded-xl p-6 border border-blue-200 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            {[
                                "item_code", "name", "category_1", "category_2", "category_3",
                                "model", "description", "hedding", "warranty", "specification",
                                "tags", "youtube_video_id"
                            ].map((field, index) => (
                                <div key={field} className="flex items-center gap-2 p-2 rounded-lg hover:bg-blue-50 transition-colors">
                    ...
                    <div className="bg-white rounded-xl p-6 border border-green-200 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            {[
                                "item_code", "price", "buy_now_price", "availability"
                            ].map((field, index) => (
                                <div key={field} className="flex items-center gap-2 p-2 rounded-lg hover:bg-green-50 transition-colors">
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div className="space-y-2">
                            ...
                            <ul className="text-amber-700 text-sm space-y-1">
                                ...
                                <li className="flex items-center gap-2">
                                    <div className="w-1 h-1 bg-amber-500 rounded-full"></div>
                                    Use the same <code className="bg-amber-100 px-1 rounded text-amber-800 font-mono text-xs">item_code</code> format for proper data matching
                                </li>
                                <li className="flex items-center gap-2">
                                    <div className="w-1 h-1 bg-amber-500 rounded-full"></div>
...
const FileUploadCard = ({ type, file, title, description, onFileSelect, onRemoveFile, onDownloadTemplate }) => {
