            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <button
                        ...
                        className="bg-[#00ad42] text-white px-4 py-2 rounded-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors duration-200 text-sm font-medium"
                    >
                        + Create Category
                    </button>
                </div>
                    ...
                    <div className="overflow-x-auto">
                        {loading ? (
                            <div className="text-center py-12">
                                ...
                                <p className="text-gray-500 text-sm mt-3">Loading categories...</p>
                            </div>
                        ) : categories.length === 0 ? (
                            <div className="text-center py-12">
                                ...
                                {categories.map((category) => (
                                    <tr key={category.id} className="hover:bg-gray-50 transition-colors duration-150">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            >
                                                {category.active !== false ? "Disable" : "Enable"}
                                            </button>
                                        </td>
                                    </tr>
                                ))}
