                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            >
                                <Download className={`w-5 h-5 text-green-600 ${exportLoading ? 'animate-pulse' : ''}`} />
                                <span>
                                    {exportLoading ? 'Exporting...' : 'Export Orders (PDF)'}
                                </span>
                            </button>
                            <button
                                ...
                                className="flex items-center justify-center gap-2 p-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                <Download className={`w-5 h-5 text-blue-600 ${exportLoading ? 'animate-pulse' : ''}`} />
                                <span>
                                    {exportLoading ? 'Exporting...' : 'Export Orders (Excel)'}
                                </span>
                            </button>
                            <button
                                className="flex items-center justify-center gap-2 p-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
