...
function AdminManagement() {
    ...
    const stats = [
        { label: 'Total Admins', value: '24', change: '+2', trend: 'up' },
        { label: 'Active Admins', value: '18', change: '+1', trend: 'up' },
        { label: 'Pending Approval', value: '3', change: '-1', trend: 'down' },
        { label: 'Inactive Admins', value: '3', change: '0', trend: 'neutral' }
    ];
    ...
    return (
        <div className="space-y-6 p-5">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <button className="mt-4 sm:mt-0 inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg transition-colors duration-200">
