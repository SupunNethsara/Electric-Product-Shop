...
function TopProduct() {
    return (
        <div className="hidden lg:flex lg:w-2/6 flex-col justify-between lg:h-[500px]">
            ...
            <div className="relative h-[calc(50%-0.75rem)] bg-white rounded-2xl shadow-xl border border-gray-100 flex overflow-hidden group transition-all duration-300 hover:shadow-2xl hover:scale-[1.01]">
                ...
                <div className="w-1/2 bg-[#cfe4ff] flex items-center justify-center p-4">
                    <img
                        src="/HeadSet.png"
                        alt="Phone Case"
                ...
                <div className="w-1/2 flex flex-col justify-center p-6 space-y-2">
                    ...
                    <button className="mt-4 w-full text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 py-2 rounded-lg transition-colors duration-300 shadow-md">
                        Grab The Deal
                    </button>
                </div>
            </div>
